<?php
namespace CGB\Fechangelog\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class CGB\Fechangelog\Controller\LogController.
 *
...
class LogControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \CGB\Fechangelog\Controller\LogController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('CGB\\Fechangelog\\Controller\\LogController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllLogsFromRepositoryAndAssignsThemToView()
	{
		...
		$logRepository = $this->getMock('CGB\\Fechangelog\\Domain\\Repository\\LogRepository', array('findAll'), array(), '', FALSE);
